...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, lsmviewdelegate {
    ...
    var tempList = ["FoxNews", "BBC", "CNN", "CNBC", "BuzzFeed", "Yahoo"]
    ...
    override func viewDidLoad() {
        ...
        self.listArray.append(ListObject(listitem: "FoxNews", isNew: false))
        self.listArray.append(ListObject(listitem: "BBC", isNew: false))
        self.listArray.append(ListObject(listitem: "CNN", isNew: false))
        self.listArray.append(ListObject(listitem: "CNBC", isNew: false))
        self.listArray.append(ListObject(listitem: "BuzzFeed", isNew: false))
        self.listArray.append(ListObject(listitem: "Yahoo", isNew: false))
