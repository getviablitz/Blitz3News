...
class LandScapeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIWebViewDelegate  {
    ...
    var tempList = ["FoxNews", "BBC", "CNN", "CNBC", "BuzzFeed", "Yahoo", "close"]
    var socialLinks = ["http://www.foxnews.com", "http://www.bbc.com/news", "http://edition.cnn.com" , "https://www.cnbc.com", "https://www.buzzfeed.com/news", "https://www.yahoo.com/news"]
    var fromView = ""
    var fromSubView = ""
    var filterArray = [Int]()
    var webToUrlString = ""
